"use components";
import { kvGet, kvSet, outboxPost, signSecp256k1 } from './host.ts';
...
const _trampoline4 = function(arg0, arg1, arg2, arg3, arg4) {
  ...
  _debugLog('[iface="t3n:escrow/host", function="sign-secp256k1"] [Instruction::CallInterface] (sync, @ enter)');
  let hostProvided = true;
  ...
  try {
    ret = { tag: 'ok', val: _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => signSecp256k1(result0, result1),
    })
  };
} catch (e) {
...
_debugLog('[iface="t3n:escrow/host", function="sign-secp256k1"][Instruction::Return]', {
  funcName: 'sign-secp256k1',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline4.fnName = 't3n:escrow/host#signSecp256k1';
...
const _trampoline5 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  ...
  _debugLog('[iface="t3n:escrow/host", function="outbox-post"] [Instruction::CallInterface] (sync, @ enter)');
  let hostProvided = true;
  ...
  try {
    ret = { tag: 'ok', val: _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => outboxPost(result0, result1, result2),
    })
  };
} catch (e) {
  ret = { tag: 'err', val: getErrorPayload(e) };
...
_debugLog('[iface="t3n:escrow/host", function="outbox-post"][Instruction::Return]', {
  funcName: 'outbox-post',
  paramCount: 0,
  async: false,
  postReturn: false
});
...
_trampoline5.fnName = 't3n:escrow/host#outboxPost';
...
const _trampoline6 = function(arg0, arg1, arg2, arg3, arg4) {
  ...
  var len1 = arg3;
  var result1 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr1, len1));
  _debugLog('[iface="t3n:escrow/host", function="kv-get"] [Instruction::CallInterface] (sync, @ enter)');
  let hostProvided = true;
...
_debugLog('[iface="t3n:escrow/host", function="kv-get"][Instruction::Return]', {
  funcName: 'kv-get',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline6.fnName = 't3n:escrow/host#kvGet';
...
const _trampoline7 = function(arg0, arg1, arg2, arg3, arg4, arg5, arg6) {
  ...
  var len2 = arg5;
  var result2 = TEXT_DECODER_UTF8.decode(new Uint8Array(memory0.buffer, ptr2, len2));
  _debugLog('[iface="t3n:escrow/host", function="kv-set"] [Instruction::CallInterface] (sync, @ enter)');
  let hostProvided = true;
  ...
  try {
    ret = { tag: 'ok', val: _withGlobalCurrentTaskMeta({
      componentIdx: task.componentIdx(),
      taskID: task.id(),
      fn: () => kvSet(result0, result1, result2),
    })
  };
} catch (e) {
  ret = { tag: 'err', val: getErrorPayload(e) };
...
_debugLog('[iface="t3n:escrow/host", function="kv-set"][Instruction::Return]', {
  funcName: 'kv-set',
  paramCount: 0,
  async: false,
  postReturn: false
...
_trampoline7.fnName = 't3n:escrow/host#kvSet';
...
let exports1Dispatch;

function dispatch(arg0) {
  var {functionName: v0_0, inputJson: v0_1 } = arg0;
  ...
  try {
    ret =   _withGlobalCurrentTaskMeta({
      taskID: task.id(),
      componentIdx: task.componentIdx(),
      fn: () => exports1Dispatch(ptr1, len1, ptr2, len2),
    });
  } catch (err) {
  ...
  switch (dataView(memory0).getUint8(ret + 0, true)) {
    ...
    case 1: {
      ...
      switch (dataView(memory0).getUint8(ret + 4, true)) {
        ...
        default: {
          throw new TypeError('invalid variant discriminant for ContractError');
        }
      }
      variant6= {
        tag: 'err',
...
const $init = (() => {
  let gen = (function* _initGenerator () {
    const module0 = fetchCompile(new URL('./escrow_contract.core.wasm', import.meta.url));
    const module1 = base64Compile('');
    const module2 = base64Compile('AGFzbQEAAAABIwVgBX9/f39/AGAHf39/f39/fwBgAn9/AGAEf39/fwBgAX8AAjMIAAEwAAAAATEAAQABMgAAAAEzAAEAATQAAgABNQADAAE2AAQACCRpbXBvcnRzAXABBwcJDQEAQQALBwABAgMEBQYALwlwcm9kdWNlcnMBDHByb2Nlc3NlZC1ieQENd2l0LWNvbXBvbmVudAcwLjI0MS4y');
    ({ exports: exports0 } = yield instantiateCore(yield module1));
    ({ exports: exports1 } = yield instantiateCore(yield module0, {
      't3n:escrow/host': {
        'kv-get': exports0['2'],
        'kv-set': exports0['3'],
        'outbox-post': exports0['1'],
        'sign-secp256k1': exports0['0'],
      },
    ...
    postReturn0 = exports1.cabi_post_dispatch;
    
    try {
      postReturn0Async = WebAssembly.promising(exports1.cabi_post_dispatch);
    } catch(err) {
      postReturn0Async = exports1.cabi_post_dispatch;
    }
    
    exports1Dispatch = exports1.dispatch;
  })();
